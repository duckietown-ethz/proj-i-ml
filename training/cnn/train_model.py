...
# Trainings Sets
training_set_r1 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r1/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r1/images/']), transform = transforms)
training_set_r2 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r2/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r2/images/']), transform = transforms)
training_set_r3 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r3/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r3/images/']), transform = transforms)
training_set_r4 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r4/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r4/images/']), transform = transforms)
training_set_r5 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r5/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r5/images/']), transform = transforms)
training_set_r6 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r6/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot04_r6/images/']), transform = transforms)
training_set_r7 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r7/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r7/images/']), transform = transforms)
training_set_r8 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r8/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r8/images/']), transform = transforms)
training_set_r9 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r9/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r9/images/']), transform = transforms)
training_set_r10 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r10/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r10/images/']), transform = transforms)
training_set_r11 = LanePoseDataset(csvPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r11/']), csvFilename='output_pose.csv', imgPath=''.join([path_to_home,'/dataset_LanePose/autobot05_r11/images/']), transform = transforms)
...
for epoch in range(num_epochs):
    ...
    for i, (images, poses) in enumerate(training_loader):
        ...
        # This function can be used to check the inputs to the model
